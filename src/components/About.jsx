    ...
    <section id="about" className="relative py-24 bg-[#FFFFF0] px-8 overflow-hidden font-['Plus_Jakarta_Sans']">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          {/* Left Side: Lightened Box with Dark Text */}
          <div className="relative group">
            {/* Decorative Gold Line Shape */}
            <div className="absolute -top-4 -left-4 w-24 h-24 border-t-4 border-l-4 border-[#DAA520] rounded-tl-3xl"></div>
            
            {/* Box: Ab ye Light Indigo hai aur Text Dark Indigo */}
            ...
            <div className="grid grid-cols-1 gap-4">
              {[
                ...
                <div key={idx} className="flex items-center gap-4 group cursor-pointer">
                  ...
                  ></div>
                  <span className="text-[#4B0082] font-extrabold text-sm tracking-wider uppercase">
                    {skill.title}
                  </span>
                </div>
              ))}
