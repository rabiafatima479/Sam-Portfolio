...
import sichook2 from '../assets/longs/27sichook2.mov';
import sichook6 from '../assets/longs/27sichook6.mp4';
import sicreel28 from '../assets/longs/27sicreel28.mov';
import sicshort1 from '../assets/longs/27sicshort1horizontal.mp4'; // Note: check extension if error
import mrCurio from '../assets/longs/mr curio long 1.mp4';
import ring118 from '../assets/longs/ring118.mov';
import ring119 from '../assets/longs/ring119.mov';
import ring120 from '../assets/longs/ring120.mov';
import ringads1 from '../assets/longs/ringads1.mp4';
import ringads2 from '../assets/longs/ringads2.mov';
import ringads3 from '../assets/longs/ringads3.mov';
import ringads4 from '../assets/longs/ringads4.mp4';
import ringads11 from '../assets/longs/ringads11.mp4';
import ringads41 from '../assets/longs/ringads41.mp4';
...
const LongVideos = ({ setSelectedContent }) => {
  const longVideosData = [
    ...
    { id: 503, title: 'The Hook Series: Part 2', localVideo: sichook2, type: 'Production', duration: '03:15', quality: 'HD' },
    { id: 504, title: 'The Hook Series: Part 6', localVideo: sichook6, type: 'Production', duration: '02:10', quality: '4K' },
    { id: 505, title: 'SIC Reel 28', localVideo: sicreel28, type: 'Reel Edit', duration: '01:50', quality: 'HD' },
    ...
    { id: 509, title: 'Ring Series 118', localVideo: ring118, type: 'Event Highlight', duration: '05:00', quality: '4K' },
    { id: 510, title: 'Ring Series 119', localVideo: ring119, type: 'Event Highlight', duration: '04:30', quality: '4K' },
    { id: 511, title: 'Ring Series 120', localVideo: ring120, type: 'Event Highlight', duration: '03:10', quality: 'HD' },
    ...
    { id: 514, title: 'Ring Advertisement 03', localVideo: ringads3, type: 'Commercial', duration: '00:45', quality: 'HD' },
    { id: 515, title: 'Ring Advertisement 04', localVideo: ringads4, type: 'Commercial', duration: '01:30', quality: '4K' },
    { id: 516, title: 'Ring Promo 11', localVideo: ringads11, type: 'Promo', duration: '02:00', quality: '4K' },
    { id: 517, title: 'Ring Promo 41', localVideo: ringads41, type: 'Promo', duration: '01:45', quality: 'HD' },
  ];
